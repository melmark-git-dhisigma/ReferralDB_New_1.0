...
namespace ReferalDB.Controllers
{
    public class GeneralInfoController : Controller
    {
                        ...
                        else if (type == "input[text]")
                        {
                            ...
                            else
                            {
                                if (TempData["EditId"] == null)
                                {
                                    ...
                                    else if (label == "Adopted age"  || label == "Age of Onset")
                                    {
                                        string funName = cell.Attributes["onkeypress"].Value;
                                    ...
                                    else if (label == "Age when Applicant")
                                    {
                                        string funName = cell.Attributes["onkeypress"].Value;
                                        html += "<td colspan=" + colspan + "><span class='fontwhite'>*</span><input id='" + id + "' name='" + id + "'  style='width:167px !important;margin-right:1px !important;' onkeypress='" + funName + "' type='text' value='" + cell.InnerText + "' /></td>";
                                    }
                            ...
                            if (val)
                            {
                                ...
                                if (label == "Relation Status")
                                {
                                    ...
                                    foreach (SelectListItem Item in ListData)
                                    {
                                        ...
                                        else if (textValue == "objRelationLegalGuardian.LegalGrRelation")
                                        {
                                            if (genModel.objRelationLegalGuardian.LegalGrRelation.ToString() == Item.Value)
                                            {
                                                html += "<option value='" + Item.Value + "' selected='true'>" + Item.Text + "</option>";
                                            }
                                            else
                                        ...
                                        else if (textValue == "objRelationEmergncyContact.EmConRelation")
                                        {
                                            if (genModel.objRelationEmergncyContact.EmConRelation.ToString() == Item.Value)
                                            {
                                                html += "<option value='" + Item.Value + "' selected='true'>" + Item.Text + "</option>";
                                            }
                                            else
                    ...
                    foreach (XmlNode cell in row.ChildNodes)
                    {
                        ...
                        else if (type == "input[text]")
                        {
                            ...
                            if (val)
                            {
                                ...
                                {
                                    string funName = cell.Attributes["onkeypress"].Value;
                                    html += "<td colspan=" + colspan + "><span class='fontwhite'>*</span><input id='" + id + "' name='" + id + "'  style='width:80px !important;margin-right:1px !important;' onkeypress='" + funName + "';  type='text' value='" + cell.InnerText + "' />YRS</td>";
                                }
                                else if (label == "Age when Applicant")
                                {
                                    string funName = cell.Attributes["onkeypress"].Value;
                                    html += "<td colspan=" + colspan + "><span class='fontwhite'>*</span><input id='" + id + "' name='" + id + "'  style='width:142px !important;margin-right:1px !important;' onkeypress='" + funName + "' type='text' value='" + cell.InnerText + "' /></td>";
                                }
                                else if (label == "Therapies")
                                {

                                    html += "<td colspan=" + colspan + "><span class='fontwhite'>*</span><input id='" + id + "' name='" + id + "'  style='width:105px !important'  type='text' value='" + cell.InnerText + "' /></td>";
                                }
                                else if (label == "Birth WeightLBS")
                                {
                                    string funName = cell.Attributes["onkeypress"].Value;
                        ...
                        else if (type == "input[textfunction]")
                        {
                            ...
                            {
                                // string funName = cell.Attributes["onkeypress"].Value;
                                html += "<td colspan=" + colspan + " ><span class='fontwhite'>*</span><input id='" + id + "' name='" + id + "' type='text' value='" + Server.HtmlEncode(cell.InnerText) + "'  onkeypress='" + funName + "' maxlength='" + maxLength + "' /></td>";
                            }
                        }
                        ...
                        else if (type == "input[dropRel]")
                        {
                            ...
                            if (val)
                            {
                                ...
                                if (label == "Relation Status")
                                {
                                    ListData = objClsRef.getRelationshipList();
                                    string textValue = cell.Attributes["modelName"].Value;
                                    html += "<td colspan=" + colspan + " ><span class='fontwhite'>*</span><select id='" + id + "' name='" + textValue.ToString() + "' class=''>";
                                    html += "<option value=''>Select " + label + "</option>";
        ...
        //--- 22Sep2020 - List 3 - Task #11 - (Start) ---//
        [HttpPost, ValidateInput(false)]
        [OutputCache(Location = System.Web.UI.OutputCacheLocation.None)]
        public ActionResult ScheduleDocumentSave(DocumentDownloadViewModel model, HttpPostedFileBase fileUpldDocName)
        {
            sess = (clsSession)Session["UserSession"];
            MelmarkDBEntities objData = new MelmarkDBEntities();
            ClsCommon clsCommon = new ClsCommon();
            ...
            if (sess != null)
            {
                if (fileUpldDocName != null)
                {
                    ...
                    if (Result != "")
                    {
                        ScheduleUploadDoccuments(sess.ReferralId, model, fileUpldDocName, sess.SchoolId, sess.LoginId);
                    }
                    else
                    {
                        return Content("Invalid file format");
        ...
        public void ScheduleUploadDoccuments(int studentPersnlId, DocumentDownloadViewModel model, HttpPostedFileBase upldFile, int schoolId, int loginId)
        {
            clsReferral objRef = new clsReferral();
            MelmarkDBEntities objData2 = new MelmarkDBEntities();
            clsDocumentasBinary objBinary = new clsDocumentasBinary();
            try
            {
                if (upldFile != null && upldFile.ContentLength > 0 && model.DocumentType != "")
                {
                    ...
                    string fileName = Path.GetFileName(upldFile.FileName);
                    //string Name = objBinary.LookName(Convert.ToInt32(model.DocumentType)); //Old code for fetching doctype
                    //int doctypeid = Convert.ToInt32(model.DocumentType);  //Old code for fetching doctype

                    int LookUpID = ((from LookUp lukup in objData2.LookUps
                                       where (lukup.LookupType == "Document Type" && lukup.LookupName=="Other" && lukup.SchoolId == sess.SchoolId)
                                       select new
                                       {                                           
                                           lukid = lukup.LookupId
                                       }).SingleOrDefault()).lukid;

                    string Name = objBinary.LookName(LookUpID);
                    int doctypeid = LookUpID;

                    //int Docid = objRef.FileUpload(studentPersnlId, schoolId, loginId, model.DocumentName, model.OtherFDocType, fileName, doctypeid);  //Old code for fetching doctype
                    int Docid = objRef.FileUpload(studentPersnlId, schoolId, loginId, model.DocumentName, model.OtherFDocType, fileName, doctypeid);
                    if (Docid > 0)
                    {
                        objBinary.SaveBinaryFiles(sess.SchoolId, sess.ReferralId, model.DocumentName, sess.LoginId, upldFile, "Referal_upld", Name, Docid);
                    }
        ...
        [OutputCache(Location = System.Web.UI.OutputCacheLocation.None)]
        public ActionResult ScheduleAppointmentUploadFiles(ScheduleAppointmentUploadFiles docDownload = null, string Name = null, string Add_doc = null)
        {
            sess = (clsSession)Session["UserSession"];
            ...
            docDownload = new ScheduleAppointmentUploadFiles();
            if (sess != null)
            {
                try
                {
        ...
        //--- 22Sep2020 - List 3 - Task #11 - (End) ---//

        // Task 28 List 3 20-Oct-2020 START--- 
        [OutputCache(Location = System.Web.UI.OutputCacheLocation.None)]
        public void EditDocumentName(int id, string DocName,int DocType)
        {
            String Name = DocName;
            int Type = DocType;
            sess = (clsSession)Session["UserSession"];
            ...
            var binDoc = objData.binaryFiles.Where(x => x.BinaryId == id && x.SchoolId == sess.SchoolId).SingleOrDefault();
            var objDoc = objData.Documents.Where(x => x.DocumentId == binDoc.DocId && x.SchoolId == sess.SchoolId).SingleOrDefault();
            if (binDoc != null)
            {
                if (DocName != " ")
                {
                    binDoc.DocumentName = DocName;
                    objDoc.DocumentName = DocName;
                }
                if (DocType != 0)
                {
        ...
        {
            sess = (clsSession)Session["UserSession"];
            DocumentDownloadViewModel returnModel = new DocumentDownloadViewModel();
            try
            {
                MelmarkDBEntities objData = new MelmarkDBEntities();
                objData = new MelmarkDBEntities();
                var binDoc = objData.binaryFiles.Where(x => x.BinaryId == id && x.SchoolId == sess.SchoolId).SingleOrDefault();
                var objDoc = objData.Documents.Where(x => x.DocumentId == binDoc.DocId && x.SchoolId == sess.SchoolId).SingleOrDefault();
                var deletedocument = objData.binaryFiles.Where(x => x.BinaryId == id).First();
                var deletedocument2 = objData.Documents.Where(x => x.DocumentId == binDoc.DocId).First();
                objData.binaryFiles.Remove(deletedocument);
                objData.Documents.Remove(deletedocument2);
                objData.SaveChanges();          
            }
            catch (Exception ex)
            {
