...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.usPhone1').mask('(000)000-00000000000000000000');
                        ...
                        <table style="border: 1px solid #F0F0F0; background: none repeat scroll 0 0 #F0F0F0;" width="100%" cellpadding="0" cellspacing="0" style="background: #F0F0F0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <%=Html.TextBoxFor(m => m.HomePhone, Model.HomePhone, new { @class="validate[custom[usPhoneNumber1]] usPhone1", @tabindex="33" })%></td>
...
<div id="contactWork" class="contactDiv" style="display: none;">
    <table style="border: 1px solid #F0F0F0; background: none repeat scroll 0 0 #F0F0F0;" width="100%" cellpadding="0" cellspacing="0">
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <span class="lblSpan">Primary Contact</span><br />
                            <%=Html.TextBoxFor(m => m.WorkHomePhone, Model.WorkHomePhone, new {  @class="validate[custom[usPhoneNumber1]] usPhone1" , @tabindex="46"})%> - 
                        </td>
                        <td colspan="2">
                            <label class="lblSpan">Ext</label><span class="greyspan-align">*</span><br />
        ...
        <tr>
            <td>
                <span class="lblSpan">City</span><br />
                <%=Html.TextBoxFor(m => m.WorkCity, Model.WorkCity, new {  @class="sd",maxlength=50, @tabindex="41" })%>
            </td>
            <td>
                <table>
                    <tr>
                        ...
                        <td colspan="2">
                            <label class="lblSpan">Ext</label><span class="greyspan-align">*</span><br />
                            <%=Html.TextBoxFor(m=>m.OtherExtension2,Model.OtherExtension2,new {@class="usPhoneExt",@style="max-width: 35px;"}) %>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <table>
                    <tr>
                        <td>
                            <span class="lblSpan">Primary Contact</span><br />
                            <%=Html.TextBoxFor(m => m.OtherHomePhone, Model.OtherHomePhone, new {  @class="validate[custom[usPhoneNumber1]] usPhone1", @tabindex="59" })%>-
                        </td>
                        <td colspan="2">
                            <label class="lblSpan">Ext</label><span class="greyspan-align"></span><br />
                            <%=Html.TextBoxFor(m=>m.OtherExtension,Model.OtherExtension,new { @class="usPhoneExt",@style="max-width: 35px;"}) %>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <td colspan="2">
                            <label class="lblSpan">Ext</label><span class="greyspan-align">*</span><br />
                            <%=Html.TextBoxFor(m=>m.OtherExtension3,Model.OtherExtension3,new {@class="usPhoneExt",@style="max-width: 35px;"}) %>
                        </td>
                    </tr>
                </table>
            </td>
